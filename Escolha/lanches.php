...
<body>
    ...
    <section id="x-cheese" class="produto-page">
        <nav class="nav-escolha"><img src="../img/logo.png" class="logo" alt="logo">
            <h1 class="titulo-pagina">X-Cheese</h1>
            <ul class="menu-principal">
                <li><a href="../paginainicio.php">Inicio</a></li>
                <li><a href="../pedidos.php">Pedidos</a></li>
                <li><a href="../sobrenos.html">Sobre nós</a></li>
        ...
        <div class="produto-detalhe"><img src="../img/X_CheeseBurguer.png" class="produto-img-detalhe" alt="X-Cheese">
            <div>
                <h1 class="produto-titulo">X-Cheese</h1>
                <p class="produto-descricao">Hambúrguer com queijo derretido.</p>
            </div>
        </div>
        <form method="post" action="#finalizacaox-cheese"><label class="label-qtd">Quantidade:</label><input
                type="number" name="quantidade" class="input-qtd" min="1" value="1" required><a class="btn-comprar"
                href="#finalizacaox-cheese">Finalizar compra</a></form>
    </section>
    ...
    <section id="finalizacaox-cheese" class="finalizacao">
        ...
        <div class="produto-finalizacao"><img src="../img/X_CheeseBurguer.png" class="img-produto-finalizacao"
                alt="X-Cheese"></div>
        <form method="post"><input type="hidden" name="produto" value="X-Cheese"><label
    ...
    <section id="x-bacon" class="produto-page">
        <nav class="nav-escolha"><img src="../img/logo.png" class="logo" alt="logo">
            <h1 class="titulo-pagina">X-Bacon</h1>
            <ul class="menu-principal">
                <li><a href="../paginainicio.php">Inicio</a></li>
                <li><a href="../pedidos.php">Pedidos</a></li>
                <li><a href="../sobrenos.html">Sobre nós</a></li>
        ...
        <div class="produto-detalhe"><img src="../img/X_Bacon.png" class="produto-img-detalhe" alt="X-Bacon">
            <div>
                <h1 class="produto-titulo">X-Bacon</h1>
                <p class="produto-descricao">Hambúrguer com bacon crocante.</p>
            </div>
        </div>
        <form method="post" action="#finalizacaox-bacon"><label class="label-qtd">Quantidade:</label><input
                type="number" name="quantidade" class="input-qtd" min="1" value="1" required><a class="btn-comprar"
                href="#finalizacaox-bacon">Finalizar compra</a></form>
    </section>
    ...
    <section id="finalizacaox-bacon" class="finalizacao">
        ...
        <div class="produto-finalizacao"><img src="../img/X_Bacon.png" class="img-produto-finalizacao" alt="X-Bacon">
        </div>
        <form method="post"><input type="hidden" name="produto" value="X-Bacon"><label
                class="label-qtd">Quantidade:</label><input type="number" name="quantidade" class="input-qtd" min="1"
                value="1" required>
            <h2 class="forma-entrega">Tipo de Entrega</h2><label><input type="radio" name="entrega" value="Entregar"
                    required> Entregar</label><label><input type="radio" name="entrega" value="Retirar" required>
    ...
    <section id="x-chicken" class="produto-page">
        <nav class="nav-escolha"><img src="../img/logo.png" class="logo" alt="logo">
            <h1 class="titulo-pagina">X-Chicken</h1>
            <ul class="menu-principal">
                <li><a href="../paginainicio.php">Inicio</a></li>
                <li><a href="../pedidos.php">Pedidos</a></li>
                <li><a href="../sobrenos.html">Sobre nós</a></li>
        ...
        <div class="produto-detalhe"><img src="../img/X_Chicken.png" class="produto-img-detalhe" alt="X-Chicken">
            <div>
                <h1 class="produto-titulo">X-Chicken</h1>
                <p class="produto-descricao">Hambúrguer de frango empanado.</p>
            </div>
        </div>
        <form method="post" action="#finalizacaox-chicken"><label class="label-qtd">Quantidade:</label><input
                type="number" name="quantidade" class="input-qtd" min="1" value="1" required><a class="btn-comprar"
                href="#finalizacaox-chicken">Finalizar compra</a></form>
    </section>
    ...
    <section id="finalizacaox-chicken" class="finalizacao">
        ...
        <div class="produto-finalizacao"><img src="../img/X_Chicken.png" class="img-produto-finalizacao"
                alt="X-Chicken"></div>
        <form method="post"><input type="hidden" name="produto" value="X-Chicken"><label
                class="label-qtd">Quantidade:</label><input type="number" name="quantidade" class="input-qtd" min="1"
                value="1" required>
            <h2 class="forma-entrega">Tipo de Entrega</h2><label><input type="radio" name="entrega" value="Entregar"
                    required> Entregar</label><label><input type="radio" name="entrega" value="Retirar" required>
    ...
    <section id="x-tudo" class="produto-page">
        <nav class="nav-escolha"><img src="../img/logo.png" class="logo" alt="logo">
            <h1 class="titulo-pagina">X-Tudo</h1>
            <ul class="menu-principal">
                <li><a href="../paginainicio.php">Inicio</a></li>
                <li><a href="../pedidos.php">Pedidos</a></li>
                <li><a href="../sobrenos.html">Sobre nós</a></li>
        ...
        <div class="produto-detalhe"><img src="../img/X_Tudo.png" class="produto-img-detalhe" alt="X-Tudo">
            <div>
                <h1 class="produto-titulo">X-Tudo</h1>
                <p class="produto-descricao">Hambúrguer completo com vários acompanhamentos.</p>
            </div>
        </div>
        <form method="post" action="#finalizacaox-tudo"><label class="label-qtd">Quantidade:</label><input type="number"
                name="quantidade" class="input-qtd" min="1" value="1" required><a class="btn-comprar"
                href="#finalizacaox-tudo">Finalizar compra</a></form>
    </section>
    ...
    <section id="finalizacaox-tudo" class="finalizacao">
        ...
        <div class="produto-finalizacao"><img src="../img/X_Tudo.png" class="img-produto-finalizacao" alt="X-Tudo">
        </div>
        <form method="post"><input type="hidden" name="produto" value="X-Tudo"><label
                class="label-qtd">Quantidade:</label><input type="number" name="quantidade" class="input-qtd" min="1"
                value="1" required>
            <h2 class="forma-entrega">Tipo de Entrega</h2><label><input type="radio" name="entrega" value="Entregar"
                    required> Entregar</label><label><input type="radio" name="entrega" value="Retirar" required>
