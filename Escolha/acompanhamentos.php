    ...
    <!-- Porção frango frito -->
        ...
        <section id="porcaofrangofrito">
            ...
            <form method="post">
                <label>Quantidade:</label>
                <input type="number" name="quantidade">
                <button><a href="#finalizacaofrangofrito">Comprar</a></button>
            </form>
    ...
    <!-- Porção Muçarela -->
        ...
        <section id="porcaomucarela">
            ...
            <form method="post">
                <label>Quantidade:</label>
                <input type="number" name="quantidade">
                <button><a href="#finalizacaomucarela">Comprar</a></button>
            </form>
    ...
    <!-- Porção Fritas -->
        ...
        <section id="porcaofritas">
            ...
            <form method="post">
                <label>Quantidade:</label>
                <input type="number" name="quantidade">
                <button><a href="#finalizacaofritas">Comprar</a></button>
            </form>
    ...
    <!-- Porção Peixe -->
        ...
        <section id="porcaopeixe">
            ...
            <form method="post">
                <label>Quantidade:</label>
                <input type="number" name="quantidade">
                <button><a href="#finalizacaopeixe">Comprar</a></button>
            </form>
